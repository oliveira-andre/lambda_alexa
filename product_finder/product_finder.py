...
class SearchProductIntentHandler(AbstractRequestHandler):
    """Handler for Search Product."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("SearchProduct")(handler_input)
...
sb.add_request_handler(SearchProductIntentHandler())
